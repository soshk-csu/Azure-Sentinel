...
|------------|-------------------------------|--------------------|
| 3.0.4      | 04-07-2026                    | Added four playbooks: Block-IP-Cloudflare, Challenge-IP-Cloudflare, Enrich-Incident-Cloudflare-SecurityEvents, Notify-Teams-Cloudflare-HighSeverity |
